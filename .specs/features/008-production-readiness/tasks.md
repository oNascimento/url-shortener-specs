...
| [ ] | F008-T05 | Consolidar matriz de aceite, migração aditiva, smoke test e rollback de imagem. | F008-T04, F008-T06 | T01–T24 e AF-01–AF-16 com evidências; nenhuma meta tratada como medição sem ensaio. |
| [ ] | F008-T06 | Validar retenção física de logs, saturação/exportação, correlação distribuída e alertas completos da aplicação. | F008-T01 | Expurgo de 14 dias observado; perdas de telemetria sinalizadas; dashboards e alertas exercitados sem dados pessoais. |
